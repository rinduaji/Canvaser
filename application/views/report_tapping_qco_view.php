									...
									<div class="card card-xl-stretch mb-5 mb-xl-12">
										...
										<div class="card-header border-0 pt-5">
											<h3 class="card-title align-items-start flex-column">
												<span class="card-label fw-bolder fs-3 mb-1">Report Tapping QCO</span>
												...
												<table id="table" class="table table-row-dashed table-row-gray-300 align-middle gs-0 gy-4">
													...
													<thead>
														<tr class="fw-bolder text-muted">
                                                            <th class="min-w-50px">LOGIN QCO</th>
															<th class="min-w-150px">NAMA QCO</th>
                                                            <th class="min-w-150px">TOTAL VALID</th>
                                                            <th class="min-w-150px">TOTAL NOT VALID</th>
                                                            <th class="min-w-150px">TOTAL RETURN TL</th>
		...
		<script>
			...
			$(document).ready(function() {
				...
				table = $('#table').DataTable({ 
					...
					"ajax": {
						"url": "<?php echo site_url('ReportTappingQCO/ajax_list')?>",
						"type": "POST"
					},
