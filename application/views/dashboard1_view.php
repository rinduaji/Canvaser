													...
													<tbody>
															...
															<td>
																<div class="d-flex align-items-center">
																	<div class="symbol symbol-45px me-5">
																		<img src="<?=base_url()?>assets/admin/media/avatars/150-11.jpg" alt="" />
																	</div>
														...
														<tr>
															...
															<td>
																<div class="d-flex align-items-center">
																	<div class="symbol symbol-45px me-5">
																		<img src="<?=base_url()?>assets/admin/media/avatars/150-3.jpg" alt="" />
																	</div>
																	<div class="d-flex justify-content-start flex-column">
														...
														<tr>
															...
															<td>
																<div class="d-flex align-items-center">
																	<div class="symbol symbol-45px me-5">
																		<img src="<?=base_url()?>assets/admin/media/avatars/150-4.jpg" alt="" />
																	</div>
																	<div class="d-flex justify-content-start flex-column">
														...
														<tr>
															...
															<td>
																<div class="d-flex align-items-center">
																	<div class="symbol symbol-45px me-5">
																		<img src="<?=base_url()?>assets/admin/media/avatars/150-5.jpg" alt="" />
																	</div>
																	<div class="d-flex justify-content-start flex-column">
														...
														<tr>
															...
															<td>
																<div class="d-flex align-items-center">
																	<div class="symbol symbol-45px me-5">
																		<img src="<?=base_url()?>assets/admin/media/avatars/150-6.jpg" alt="" />
																	</div>
																	<div class="d-flex justify-content-start flex-column">
							...
							<div class="row gy-5 g-xl-12">
								...
								<div class="col-xl-12">
									...
									<div class="card card-xl-stretch mb-5 mb-xl-12">
										...
										<div class="card-header border-0 pt-5">
											<h3 class="card-title align-items-start flex-column">
												<span class="card-label fw-bolder fs-3 mb-1">Input CWC</span>
												<!-- <span class="text-muted mt-1 fw-bold fs-7">Over 500 members</span> -->
											</h3>
										</div>
										<!--end::Header-->
										...
										<div class="card-body py-3">
											...
											<form class="row g-3">
												<div class="col-md-4">
													...
													<input type="number" class="form-control" id="fastel">
												</div>
												<div class="col-md-4">
													<label for="nama_dm" class="form-label">NAMA DM / PEMILIK</label>
													<input type="text" class="form-control" id="nama_dm">
												</div>
												<div class="col-md-4">
												...
												<div class="col-md-6">
													...
													<select class="form-control form-select" id="reg">
												...
												<div class="col-md-6">
													...
													<select class="form-control form-select" id="witel">
												...
												<div class="col-md-6">
													...
													<select class="form-control form-select" id="jenis">
												...
												<div class="col-md-4">
													<label for="selisih_harga" class="form-label">SELISIH HARGA</label>
													<input type="text" class="form-control" id="selisih_harga">
												</div>
												<div class="col-md-4">
												...
												<div class="col-12">
													...
													<textarea class="form-control" id="ket" rows="5"></textarea>
												</div>
