<?php 
 ...
 class M_approve extends CI_Model {
    ...
    var $column_order = array('id','tgl','login','name','witel','fastel','nama_dm','tlp','jenis','reason','input','ket','upd_qco','rec_qco',null); //set column field database for datatable orderable
    var $column_search = array('id','tgl','login','name','witel','fastel','nama_dm','tlp','jenis','reason','input','ket','upd_qco','rec_qco'); //set column field database for datatable searchable just firstname , lastname , address are searchable
