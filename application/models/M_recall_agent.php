<?php 
 ...
 class M_recall_agent extends CI_Model {
    
    var $table1 = 'app_data_canvas';
    var $table2 = 'cc147_main_users';
    var $table3 = 'cc147_main_users_extended';
    var $column_order = array('app_data_canvas.id','tgl','login','name','witel','fastel','nama_dm','tlp','app_data_canvas.jenis','reason','input','ket','upd_qco','rec_qco','upd_tl','rec_tl','user3',null); //set column field database for datatable orderable
    var $column_search = array('app_data_canvas.id','tgl','login','name','witel','fastel','nama_dm','tlp','app_data_canvas.jenis','reason','input','ket','upd_qco','rec_qco','upd_tl','rec_tl','user3'); //set column field database for datatable searchable just firstname , lastname , address are searchable
    ...
    private function _get_datatables_query($tanggal)
    {
        ...
        $this->db->join($this->table3, $this->table1.'.login = '.$this->table3.'.user1');
        $this->db->where('follow', '5');
